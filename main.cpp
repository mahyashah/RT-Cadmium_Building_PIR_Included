...
#include "../atomics/Fire_Sensor.hpp"
  ...
  const char* A1  = "./inputs/A1_IR_1.txt";
  const char* A3  = "./inputs/A3_IR_2.txt";
  const char* A0  = "./inputs/A0_PIR_1.txt";
  const char* A2  = "./inputs/A2_PIR_2.txt";
...
/********************************************/
  ...
  AtomicModelPtr PIR_LED_Controller = cadmium::dynamic::translate::make_dynamic_atomic_model<PIR_LED_Con, TIME>("PIR_LED_Controller");
  ...
  AtomicModelPtr PIR_Sensor_Controller1 = cadmium::dynamic::translate::make_dynamic_atomic_model<PIR_Sensor, TIME>("PIR_Sensor_Controller1");
  AtomicModelPtr PIR_Sensor_Controller2 = cadmium::dynamic::translate::make_dynamic_atomic_model<PIR_Sensor, TIME>("PIR_Sensor_Controller2");
...
/****************** Input *******************/
/********************************************/
  AtomicModelPtr IR_1 = cadmium::dynamic::translate::make_dynamic_atomic_model<DigitalInput, TIME>("IR_1", A1);
  AtomicModelPtr IR_2 = cadmium::dynamic::translate::make_dynamic_atomic_model<DigitalInput, TIME>("IR_2", A3);
   AtomicModelPtr PIR_1 = cadmium::dynamic::translate::make_dynamic_atomic_model<DigitalInput, TIME>("PIR_1", A0);
  AtomicModelPtr PIR_2 = cadmium::dynamic::translate::make_dynamic_atomic_model<DigitalInput, TIME>("PIR_2", A2);
...
struct emerg_PIR_1_in : public cadmium::in_port<bool>{};
struct emerg_PIR_2_in : public cadmium::in_port<bool>{};
...
struct emerg_E3L1_out : public cadmium::out_port<bool>{};
struct emerg_E3L2_out : public cadmium::out_port<bool>{};
  cadmium::dynamic::modeling::Ports iports_EMERG_SYS = {typeid(emerg_temp_in), typeid(emerg_switch_in),typeid(emerg_PIR_1_in), typeid(emerg_PIR_2_in) };
  cadmium::dynamic::modeling::Ports oports_EMERG_SYS = {typeid(emerg_alarm_out), typeid(emerg_E1L1_out), typeid(emerg_E1L2_out), typeid(emerg_E2L1_out), typeid(emerg_E2L2_out), typeid(emerg_E3L1_out), typeid(emerg_E3L2_out)};
  cadmium::dynamic::modeling::Models submodels_EMERG_SYS =  {Alarm_Monitor, Emergency_LED_Controller1, Emergency_LED_Controller2, PIR_LED_Controller, PIR_Sensor_Controller1, PIR_Sensor_Controller2, Fire_Alarm_Controller, Fire_Sensor};
  cadmium::dynamic::modeling::EICs eics_EMERG_SYS = {
    ...
    cadmium::dynamic::translate::make_EIC<emerg_PIR_1, PIR_Sen_defs::inp>("PIR_Sensor_Controller1"),
    cadmium::dynamic::translate::make_EIC<emerg_PIR_2, PIR_Sen_defs::inp>("PIR_Sensor_Controller2"),
  };
  cadmium::dynamic::modeling::EOCs eocs_EMERG_SYS = {
     ...
     cadmium::dynamic::translate::make_EOC<PIR_LED_defs::out_r, emerg_E3L1_out>("PIR_LED_Controller"),
     cadmium::dynamic::translate::make_EOC<PIR_LED_defs::out_g, emerg_E3L2_out>("PIR_LED_Controller"), 
  ...
  cadmium::dynamic::modeling::ICs ics_EMERG_SYS = {
     ...
     cadmium::dynamic::translate::make_IC<PIR_Sen_defs::out, LED_defs::inpa>("PIR_Sensor_Controller1", "PIR_LED_Controller"),
     cadmium::dynamic::translate::make_IC<PIR_Sen_defs::out, 
LED_defs::inpa>("PIR_Sensor_Controller2", "PIR_LED_Controller"),
     cadmium::dynamic::translate::make_IC<Alarm_defs::out,
LED_defs::inpb>("Alarm_Monitor", "PIR_LED_Controller3"), 
  };
...
/*************************/
  ...
  cadmium::dynamic::modeling::Models submodels_TOP =  {ROOM_LED, EMERG_SYS, lightSensor, TempSensor, FireSwitch,PIR_1, PIR_2, IR_1, IR_2, AlarmOut, R1L1, R1L2, R2L1, R2L2, E1L1, E1L2, E2L1, E2L2, E3L1, E3L2};
  ...
  cadmium::dynamic::modeling::ICs ics_TOP = {
    ...
    cadmium::dynamic::translate::make_IC<digitalInput_defs::out, emerg_Motion_in>("PIR_1","EMERG_SYS"),
    cadmium::dynamic::translate::make_IC<digitalInput_defs::out, emerg_Motion_in>("PIR_2","EMERG_SYS"),
     ...
     cadmium::dynamic::translate::make_IC<emerg_E3L1_out, digitalOutput_defs::in>("EMERG_SYS", "E3L1"),
     cadmium::dynamic::translate::make_IC<emerg_E3L2_out, digitalOutput_defs::in>("EMERG_SYS", "E3L2"),
