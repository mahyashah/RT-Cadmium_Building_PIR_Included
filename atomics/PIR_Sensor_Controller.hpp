...
#define BOOST_SIMULATION_PDEVS_PIR_SENSOR_CONTROLLER_HPP
...
//Port definition
    struct PIR_Sensor_Controller_defs {
        //Output ports
    ...
    class PIR_Sensor_Controller {
        using defs= PIR_Sensor_Controller_defs; // putting definitions in context
        public:
            //Parameters to be overwriten when instantiating the atomic model
            
            // default constructor
            PIR_Sensor_Controller() noexcept{
              state.type = false;
              state.occ = false;
            }
            ...
            friend std::ostringstream& operator<<(std::ostringstream& os, const typename PIR_Sensor_Controller<TIME>::state_type& i) {
...
#endif // BOOST_SIMULATION_PDEVS_PIR_SENSOR_CONTROLLER_HPP
